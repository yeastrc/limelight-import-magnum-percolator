...
public class MagnumResultsReader_TestAddPSMToResults {
	...
	public void setUp() throws Throwable {
		...
		columnHeaderMap = MagnumTextResultsReader.getHeaderColumns( headerLine );
		...
		
		{
			...
			MagnumPSM psm = MagnumTextResultsReader.getMagnumPSM( PSMLine,  columnHeaderMap );
			
			MagnumTextResultsReader.addPSMToMagnumResults( psm,  magnumResults );
		}
