...
public class MainProgram implements Runnable {
	...
	@CommandLine.Option(names = { "-m", "--magnum" }, required = true, description = "Full path to the PepXML file generated by Magnum.")
	private File magnumFile;

	@CommandLine.Option(names = { "-p", "--percolator" }, required = true, description = "Full path to the XML file generated by Percolator.")
	...
	public void run() {
        ...
        cp.setMagnumParametersFile( confFile );
